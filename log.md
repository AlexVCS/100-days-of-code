...
**Today's Progress**: Tried out Next.js for the first time. After hearing lots about it I needed to see for myself. Love it so far! I went through the well written tutorial to start a simple blog. It's optimized nicely and has nice built in features on top of React. Look forward to doing more with it. Unfortunately my left hand doesn't like all the coding I've been doing it seems. Have to try & minimize the typing with it atm.
...
### Day 11: November 12th, 2020

**Today's Progress**: Got back to Full Stack Open. Always good to remember the console is your friend! Starting to solve issues with logging to the console first is a game changer. I did that and will work from there. Continued with the Next.js blog too :)
...
**Today's Progress**: More progress with the Next.js blog. See myself using Next to create apps in the future. Looked more at the anecdotes app I've been building, trying to add onto the logic I have, research and programmatically problem solve. Booyah!
...
**Today's Progress**: Built even more of my React form. Approaching it differently and thinking through each step more thoroughly. Juxtaposing what I'm writing with Mad Libzz to see the lessons I can bring over from the form. Worked on freeCodeCamp encore ;)

**Thoughts** Tired but I'm out here coding like I do everyday!

**Link(s) to work**: N/A (for now)

### Day 97: February 6th, 2021

**Today's Progress**: Finished recreating my React form. Had to figure out how to better set the errors in the state & more. It works as intended and is making more sense to me. Read a cool article shared with me about coding languages used in crypto. Nice to see what's being used to create it. Made changes to Mad Libzz.
